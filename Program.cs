...
public class BookManager
{
    ...
    {
        // Set the directory path and create the path for books.json
    ...
    public void AddBook(string title, string author, int yearOfPublication)
    {
        ...
        books.Add(newBook);
        SaveBooks();  // Save the updated list to the JSON file
...
// es mushaobs kargad garda iuserisa ar aqvs

*/
/*
 //es aris bolo da mushaobs kargad garda passord konfirmaciisa
...
//mushaobs  mxolod igive iuserit rom registrirdeba agdebs programidan
/*
using Newtonsoft.Json;
using System;
using System.Collections.Generic;
...
class Program
{
   ...
   static bool UserLogin(UserManager userManager)
   {
       ...
       else if (choice == "2")
       {
           ...
           if (userManager.RegisterUser(username, password, confirmPassword))
           {
               return true;
           }
       }
